# CAPE 🌴 ![pylint](https://img.shields.io/github/actions/workflow/status/gcambara/cape/Pylint?label=pylint) ![pytest](https://img.shields.io/github/actions/workflow/status/gcambara/cape/Pytest?label=pytest)
